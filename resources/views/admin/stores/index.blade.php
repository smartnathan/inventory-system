    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-title">
                <a href="{{ url('/admin/stores/create') }}" class="btn btn-success btn-sm" title="Add New store">
                    ...
                    <span class="bold"> Add Stores</span>
                </a>
        ...
        <div class="ibox-content">
            <div class="row">
                ...
                <div class="col-sm-3">
                        {!! Form::open(['method' => 'GET', 'url' => '/admin/stores', 'role' => 'search'])  !!}
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th>#</th><th>Name</th><th>Address</th><th>Created By</th><th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                    @foreach($stores as $item)
                        <tr>
                            ...
                            <td>{{ $item->name }}</td><td>{{ $item->address }}</td><td>{{ $item->user->name }}<br><span class="badge badge-danger">{{ $item->user->roles[0]->label }}</span></td>
                            <td>
