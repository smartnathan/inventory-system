...
<div class="form-group{{ $errors->has('manufacturer_id') ? 'has-error' : ''}} col-md-4" style="">
...
<div style="margin-left: 5px !important" class="form-group{{ $errors->has('name') ? 'has-error' : ''}} col-md-4">
...
<div class="form-group">
    {!! Form::submit($formMode === 'edit' ? 'Update Product' : 'Add Product', ['class' => 'pull-right btn btn-primary', 'onclick' => "return confirm('Are you sure you want to add this product?')"]) !!}
</div>
